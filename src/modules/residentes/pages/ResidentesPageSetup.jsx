    ...
    return (
        <div className="max-w-2xl mx-auto p-6">
            ...
            <div className="bg-gray-800 rounded-lg p-8 text-center border border-gray-700">
                ...
                <div className="bg-gray-700 bg-opacity-50 rounded-lg p-6 mb-6 border border-gray-600">
                    <div className="flex items-center justify-center mb-3">
                        <i className="fas fa-users text-blue-400 mr-2 text-lg"></i>
                        <span className="text-sm font-medium text-blue-300">Próximo paso</span>
                    </div>
                ...
                <div className="flex gap-4 justify-center">
                    ...
                    <button
                        ...
                        className="bg-gray-600 hover:bg-gray-500 text-gray-200 font-medium py-3 px-8 rounded-lg transition-colors duration-200 border border-gray-500"
                    >

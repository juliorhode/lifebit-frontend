...
const ListaResidentes = ({
    ...
    const [eliminandoLocalId, setEliminandoLocalId] = useState(null);

    // Función obsoleta - la suspensión ahora se maneja desde ResidentesPage.jsx

    // Función obsoleta - la edición ahora se maneja desde ResidentesPage.jsx

    /**
     * @description Obtiene el badge de estado para un residente
     * @param {string} estado - Estado del residente ('activo' o 'pendiente')
     * @returns {Object} Configuración del badge {color, texto, icono}
     */
        ...
        <div className="bg-gray-800 rounded-lg overflow-hidden">
                ...
                <div className="flex flex-col sm:flex-row gap-4 items-start sm:items-center justify-between">
                    ...
                    <div className="flex gap-3 items-center">
                        ...
                        <button
                            onClick={onRefresh}
                            disabled={isLoading}
                            className="px-3 py-2 bg-gray-700 hover:bg-gray-600 border border-gray-600 rounded-lg text-white transition-colors duration-200 disabled:opacity-50 flex items-center gap-2"
            ...
            <div className="overflow-x-auto">
                {isLoading ? (
                    ...
                    <div className="p-6">
                        {[...Array(5)].map((_, i) => (
                            <div key={i} className="animate-pulse flex items-center py-3 border-b border-gray-700 last:border-b-0">
                    ...
                    <div className="p-12 text-center">
                        ...
                        <h3 className="text-gray-400 text-lg font-medium mb-2">No hay residentes</h3>
